  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        <a href="https://github.com/marcusdnhartwig?tab=repositories" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
          ...
          <Nav.Item>
            <Switch 
              ...
              uncheckedIcon={
                <span
                  className="iconify"
                  data-icon="twemoji:man-astronaut"
                  data-inline="false"
                  style={{
                    display: "block",
                    height: "100%",
